...
namespace ProductVariantBundle.Infrastructure.Migrations
{
    ...
    [Migration("20251019185036_InitialCreate")]
            ...
            modelBuilder.Entity("ProductVariantBundle.Core.Entities.SellableItem", b =>
                {
                    ...
                    b.ToTable("SellableItems", null, t =>
                        {
                            t.HasCheckConstraint("ck_sellable_item_one_of", "(\"VariantId\" IS NOT NULL AND \"BundleId\" IS NULL) OR (\"VariantId\" IS NULL AND \"BundleId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ProductVariantBundle.Core.Entities.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            Code = "MAIN",
                            CreatedAt = new DateTime(2025, 10, 19, 18, 50, 35, 506, DateTimeKind.Utc).AddTicks(4791),
                            Name = "Main Warehouse",
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 10, 19, 18, 50, 35, 506, DateTimeKind.Utc).AddTicks(4792)
                        });
                });
