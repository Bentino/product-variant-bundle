...
namespace ProductVariantBundle.Infrastructure.Migrations
{
    ...
    [Migration("20251020203137_InitialCreate")]
            ...
            modelBuilder.Entity("ProductVariantBundle.Core.Entities.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            Code = "MAIN",
                            CreatedAt = new DateTime(2025, 10, 20, 20, 31, 36, 73, DateTimeKind.Utc).AddTicks(8732),
                            Name = "Main Warehouse",
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 10, 20, 20, 31, 36, 73, DateTimeKind.Utc).AddTicks(8735)
                        });
                });
